            ...
            <div id="topbar">
                <nav id="linkNav">
                    <ul id="pagelinks">
                        ...
                        <li><a class = "selected" href="/HomeManagement/EarningMember">Earning_Members</a></li>
                ...
                <table style="width:100%">
                    ...
                    <tbody>
                        <c:forEach items="${EarningList}" var="earning">
                            <tr>
                                <td><c:out value="${earning.earningmember_name}" /></td>
                                <td><c:out value="${earning.earningmember_occupation}" /></td>
                                <td><c:out value="${earning.earningmember_income}" /></td>
